...
def EEEcreatsuite1():
    casedir=[]
    listaa=os.listdir('../selenium_proces/')
    for xx in listaa:
        if "thread" in xx:
            casedir.append(xx)
    print casedir
    ...
    for n in casedir:
        ...
        discover=unittest.defaultTestLoader.discover(str(n),pattern = 'start_*.py',top_level_dir=r'/home/ada/lily/RCGT/note/unittest/selenium_proces')
        #print "discover"
        #print discover
